...
const MyProfile = () => {
  ...
  return (
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <img className='w-24 rounded-full' src={userData.image} alt="" />
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {isEdit ?
            <select className='bg-gray-50' onChange={e => setUserData(prev => ({ ...prev, gender: e.target.value }))} value={userData.gender} name="gender" id="gender">
          ...
          {isEdit ?
            <input className='bg-gray-50' type="date" value={userData.dob} onChange={e => setUserData(prev => ({ ...prev, dob: e.target.value }))} />
