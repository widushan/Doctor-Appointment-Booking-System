    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6 md:w-2/4 text-sm text-gray-600'>
          ...
          <p className='text-gray-500'>54709 Wiliams Station <br /> Suite 350, Washington, USA</p>
          <p className='text-gray-500'>Tel: 415 - 555 - 1234 <br /> Email: medixgo2026@gmail.com</p>
          <p className='font-semibold text-lg text-gray-600'>Careers at MedixGo</p>
