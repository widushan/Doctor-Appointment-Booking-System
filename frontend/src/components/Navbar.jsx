...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <img
        onClick={() => navigate('/')}
        className='w-44 cursor-pointer' src={assets.MedixGo} alt="" />
      ...
      <div className='flex items-center gap-4'>
        ...
        {showMenu && (
          <div className='fixed inset-0 bg-black bg-opacity-50 z-50'>
            <div className='absolute right-0 top-0 w-64 bg-white h-full'>
              <img
                onClick={() => setShowMenu(false)}
                className='w-6 absolute top-4 right-4 cursor-pointer' src={assets.cross_icon} alt="" />
